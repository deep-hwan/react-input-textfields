...
var Absolute = (0, react_1.forwardRef)(function (props, ref) {
    ...
    return ((0, jsx_runtime_1.jsx)("div", __assign({ ref: ref, css: __assign(__assign(__assign(__assign(__assign(__assign({ zIndex: zIndex, width: width !== null && width !== void 0 ? width : "auto", minWidth: minWidth, maxWidth: maxWidth, height: height, minHeight: minHeight, maxHeight: maxHeight, position: "absolute", top: position.top, bottom: position.bottom, left: position.left, right: position.right, backgroundColor: backgroundColor, borderRadius: borderRadius, order: order, transition: "".concat(transitionTime !== null && transitionTime !== void 0 ? transitionTime : 0, "s ease-in-out"), transform: "translate(".concat((_a = axis === null || axis === void 0 ? void 0 : axis.x) !== null && _a !== void 0 ? _a : 0, ", ").concat((_b = axis === null || axis === void 0 ? void 0 : axis.y) !== null && _b !== void 0 ? _b : 0, ")") }, FlexT), spaceT), scrollT), borderT), shadowT), cursorT) }, rest, { children: rest.children })));
});
